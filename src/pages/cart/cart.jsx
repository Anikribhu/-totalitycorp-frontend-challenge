...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_hv2bkCP8ewWAcb",
      key_secret: "i8ofCNKpDivNWi5ViVtJLdHG",
              ...
              return (
                ...
                >
                  <img
                    src={item.imageUrl}
                    alt="product-image"
                    className="w-full h-32 object object-contain object-top rounded-lg sm:w-40"
                  />
                  <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                    <div className="mt-5 sm:mt-0">
                      ...
                      <p
                        className="mt-3 text-lg font-semibold text-gray-600"
                        style={{ color: mode === "dark" ? "white" : "" }}
                      >
                        ₹{item.price}
                      </p>
